...
var div = document.createElement('div');//создаем блок счетчика
div.className = "coines";//присваиваем класс
document.body.appendChild(div);//добавляем в конец тела боди блок со счетчиком
...
function haveFood(unit) {
    ...
    if (unit_classes.includes('food-unit')) {
        ...
        div.innerHTML = score;//добавляем значение игры в блок div
      }
    return check;
}
